[#ftl]
[@b.textfield name="goodPost.name" label="名称" value="${goodPost.name!}" required="true" maxlength="200"/]
...
[@b.textarea label="方案" cols="50" rows="8" name="goodPost.plan" value=(goodPost.plan)! maxlength="3000" required="true"/]
