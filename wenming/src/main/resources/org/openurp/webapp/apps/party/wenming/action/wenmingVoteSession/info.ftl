...
<table class="infoTable">
  <tr>
   ...
   <td class="content" width="35%"> ${wenmingVoteSession.session.name}</td>
   <td class="title" width="15%">投票批次名称:</td>
   <td class="content" width="35%"> ${wenmingVoteSession.name}</td>
  </tr>
  <tr>
   <td class="title" width="15%">优秀项目投票上限:</td>
   <td class="content" width="35%"> ${wenmingVoteSession.limit}票</td>
  </tr>
  <tr>
   <td class="title" width="15%">好人好事投票上限:</td>
   <td class="content" width="35%"> ${wenmingVoteSession.limit2}票</td>
  </tr>
  <tr>
   <td class="title" width="15%">文明示范岗投票上限:</td>
   <td class="content" width="35%"> ${wenmingVoteSession.limit3}票</td>
  </tr>
  <tr>
