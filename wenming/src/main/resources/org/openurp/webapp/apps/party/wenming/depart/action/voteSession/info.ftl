...
<table class="infoTable">
  ...
  <tr>
   <td class="title" width="10%">教学部门投票上限:</td>
   <td class="content" width="40%"> ${voteSession.limit}票</td>
   <td class="title" width="10%">职能部门投票上限:</td>
   <td class="content" width="40%"> ${voteSession.limit2}票</td>
  </tr>
  <tr>
  ...
  <tr>
   <td class="title" width="10%">被投票部门:</td>
